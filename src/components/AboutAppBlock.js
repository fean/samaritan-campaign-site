...
const AboutAppBlock = () => (
  <div className="container overflow-hidden max-w-4xl flex flex-col mx-auto px-3 pt-16 pb-16 md:pt-20 md:pb-20">
    <h1 className="font-bold pb-10 text-center text-[30px] md:text-[32px] text-[#001133]">
      Our mission
    </h1>
    <p className="font-black font-normal text-center text-[18px] text-[#3C455D]">
      The humanitarian refugee effort has been miraculous in the last couple of
